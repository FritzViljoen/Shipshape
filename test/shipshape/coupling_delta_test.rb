...
class CouplingDeltaTest < Minitest::Test
  ...
  def test_a_cut_and_an_arriving_file_are_reported_separately
    base = report(
      edges: [Edge.new(caller: "app/deeds/create_person.rb", callee: "app/questions/list_people.rb")] * 2,
      governed: %w[app/deeds/create_person.rb app/questions/list_people.rb],
    )
    head = report(
      edges: [Edge.new(caller: "app/deeds/create_person.rb", callee: "app/questions/list_people.rb")] +
             [Edge.new(caller: "app/deeds/big.rb", callee: "app/questions/list_people.rb")] * 3,
      governed: %w[app/deeds/create_person.rb app/questions/list_people.rb app/deeds/big.rb],
    )
  ...
  def test_a_callee_arriving_under_governance_is_flat_not_a_rise
    base = report(edges: [], governed: %w[app/deeds/create_person.rb])
    head = report(
      edges: [Edge.new(caller: "app/deeds/create_person.rb", callee: "app/questions/list_people.rb")],
      governed: %w[app/deeds/create_person.rb app/questions/list_people.rb],
    )
  ...
  def test_a_file_leaving_governance_reports_left_not_a_fall
    base = report(
      edges: [Edge.new(caller: "app/deeds/old_thing.rb", callee: "app/questions/list_people.rb")],
      governed: %w[app/deeds/old_thing.rb app/questions/list_people.rb],
    )
    head = report(edges: [], governed: %w[app/questions/list_people.rb])
  ...
  def test_a_moved_caller_that_gains_an_edge_is_not_hidden_by_the_move
    base = report(edges: [Edge.new(caller: "app/deeds/create_person.rb", callee: "app/questions/list_people.rb")],
                  governed: %w[app/deeds/create_person.rb app/questions/list_people.rb app/questions/list_pets.rb])
    head = report(
      edges: [Edge.new(caller: "app/deeds/people/create_person.rb", callee: "app/questions/list_people.rb"),
              Edge.new(caller: "app/deeds/people/create_person.rb", callee: "app/questions/list_pets.rb")],
      governed: %w[app/deeds/people/create_person.rb app/questions/list_people.rb app/questions/list_pets.rb],
    )

    totals = delta(base, head, renames: { "app/deeds/create_person.rb" => "app/deeds/people/create_person.rb" })
  ...
  def test_a_moved_callee_whose_caller_triples_its_calls_is_not_hidden_by_the_move
    base = report(edges: [Edge.new(caller: "app/deeds/create_person.rb", callee: "app/questions/list_people.rb")],
                  governed: %w[app/deeds/create_person.rb app/questions/list_people.rb])
    head = report(
      edges: [Edge.new(caller: "app/deeds/create_person.rb", callee: "app/questions/people/list_people.rb")] * 3,
      governed: %w[app/deeds/create_person.rb app/questions/people/list_people.rb],
    )

    totals = delta(base, head, renames: { "app/questions/list_people.rb" => "app/questions/people/list_people.rb" })
  ...
  def test_a_delete_and_an_unrelated_add_are_not_paired_by_governance_alone
    base = report(edges: [Edge.new(caller: "app/deeds/old_thing.rb", callee: "app/questions/list_people.rb")],
                  governed: %w[app/deeds/old_thing.rb app/questions/list_people.rb])
    head = report(
      edges: [Edge.new(caller: "app/deeds/new_thing.rb", callee: "app/questions/list_people.rb")] * 4,
      governed: %w[app/deeds/new_thing.rb app/questions/list_people.rb],
    )
