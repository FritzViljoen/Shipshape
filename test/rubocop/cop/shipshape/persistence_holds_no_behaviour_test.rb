...
class PersistenceHoldsNoBehaviourTest < Minitest::Test
  ...
  def test_delegate_outside_a_record_is_not_this_cops_business
    assert_empty offences(<<~RUBY, cop_class: COP, path: "app/questions/list_bookings.rb", other_cops: LAYOUT)
      class ListBookings < Question
  ...
  def test_the_default_scope_offence_names_create_and_offers_a_named_question
    ...
    assert_includes message, "class ListLiveBookings < Question"
  end
  ...
  def test_the_offence_carries_the_reason_and_an_example
    ...
    assert_includes message, "class TotalBooking < Question"
  end
  ...
  def test_a_question_may_hold_all_the_behaviour_it_likes
    assert_empty offences(<<~RUBY, cop_class: COP, path: "app/questions/total_booking.rb", other_cops: LAYOUT)
      class TotalBooking
        def call
