  ...
  module Cop
    module Shipshape
      ...
      class NoDecisionsInRequestHandling < Base
        ...
        # The two questions this layer may ask, and the only two. `success?` is a deed's
        # outcome; `present?` is whether a question found anything, and it answers correctly for
        ...
        PLACED = <<~RUBY
          result = SomeDeed.call(...)   # answers success(...) or failure(:code)
