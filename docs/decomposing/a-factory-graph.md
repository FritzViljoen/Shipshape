...
**A factory sets columns; a deed enforces which combinations of them are legal.** So a
...
| **a state no deed can reach** | **stop.** Either the deed is missing, or the test is asserting fiction |
