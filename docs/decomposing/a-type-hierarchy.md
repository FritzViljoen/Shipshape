...
stays a class. But it becomes a **deed or question**, not a record subclass:
...
chosen at the edge — request handling picks which deed to call — rather than by a record
