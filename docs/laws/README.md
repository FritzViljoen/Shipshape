...
| [`a-write-is-one-transaction`](a-write-is-one-transaction.md) | `make-the-wrong-thing-impossible` |
| [`a-read-writes-nothing`](a-read-writes-nothing.md) | `good-boundaries-make-good-neighbours` |
...
| [`a-write-runs-twice`](a-write-runs-twice.md) | `tell-dont-ask` |
| [`every-operation-reports-what-it-did`](every-operation-reports-what-it-did.md) | `nothing-fails-quietly` |
| [`deferral-is-one-write`](deferral-is-one-write.md) | `good-boundaries-make-good-neighbours` |
